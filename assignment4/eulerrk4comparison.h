...
public:
    ...
    DoubleProperty stepSizeEuler;
    DoubleProperty stepSizeRK4;

    IntProperty numberPointsEuler;
    IntProperty numberPointsRK4;

    FloatVec4Property colorEuler;
    FloatVec4Property colorRK4;
